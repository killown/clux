...
impl Clux {
    pub fn new(event_loop: &mut EventLoop<Self>, display: Display<Self>) -> Self {
        ...
        // Some of them require us to implement traits on the Clux state,
    ...
    fn init_wayland_listener(display: Display<Clux>, event_loop: &mut EventLoop<Self>) -> OsString {
...
/// Data associated with a wayland client that connects to Clux.
